<?php $this->layout('layouts/admin', ['title' => 'Editar Fornecedor']) ?>

<?php $this->start('body') ?>
<div class="card shadow-sm" id="formView">
    <?php $this->insert('partials/admin/form/header', ['title' => 'Editar Fornecedor']) ?>
    <div class="card-body">
        <form method="post" action="/admin/suppliers/update" enctype="multipart/form-data" class="">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome da empresa"
                           value="<?= $this->e(($supplier['name'] ?? '')) ?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="cnpj" name="cnpj"
                           placeholder="00.000.000/0000-00" value="<?= $this->e(($supplier['cnpj'] ?? '')) ?>">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                           placeholder="Digite o e-mail" value="<?= $this->e(($supplier['email'] ?? '')) ?>">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="tel" class="form-control" id="telefone" name="telefone"
                           placeholder="(00) 00000-0000" value="<?= $this->e(($supplier['telefone'] ?? '')) ?>">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="endereco" name="endereco"
                           placeholder="Digite o endereço completo" value="<?= $this->e(($supplier['endereco'] ?? '')) ?>">
