<?php $this->layout('layouts/admin', ['title' => 'Detalhe do Usuário']) ?>
        ...
        <div class="card-body">
            <form>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?= $this->e($user['id']) ?>" readonly>
                </div>
                <div class="mb-3">
                    <label class="form-label"><strong>Nome:</strong></label>
                    <input type="text" class="form-control" value="<?= $this->e($user['name']) ?>" readonly>
                </div>
                <div class="mb-3">
